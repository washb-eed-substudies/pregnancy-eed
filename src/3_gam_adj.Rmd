...
#Save results
saveRDS(H3_adj_res, "results/adjusted/H3_adj_res.RDS")
...
#Save plot data
saveRDS(H3_adj_plot_data, "figure-data/H3_adj_spline.data.RDS")
```
```{r}
results <- readRDS("results/adjusted/H3_adj_res.RDS")
write_csv(results,"results/adjusted/H3_adj_res.csv")
```
